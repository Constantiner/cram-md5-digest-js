...
describe("cramMd5Digest", () => {
	describe("cramMd5DigestBase64 without padding", () => {
		it("Base64 digest without padding should be calculated right", () => {
			...
			).toBe("ZDYxODU1ODhjNGVhODMwNzhkNmFiN2MwYmNlZGU0NTA");
			expect(
				cramMd5DigestBase64(
			...
			expect(cramMd5DigestBase64("th7)(fx2634l5a5", "b4x7b-4ha7B9nqz5RI9v904/5b6Q3&0dx)H#pn14$k_5usF4&)3lmo")).toBe(
			...
			expect(cramMd5DigestBase64("83t)", "Ie987ALLt456!/i76e$21u6Xq_@L45/2F/ssjhxf1xgYfaG9ql#RK7(tuCHns43e")).toBe(
	...
	describe("cramMd5DigestBase64 with padding", () => {
		it("Base64 digest with padding should be calculated right", () => {
			...
			expect(cramMd5DigestBase64("YC+HxEC8m40c@+g2_g67mV8!ve2-6", "LS8NiuZGxtQ49#gU9f(5aSWl6cT28_(-&1v", true)).toBe(
				"ZmU5ODRlYmY0OTZkOGVmN2M0NjZkNGM1M2U2NmRmYTA="
			);
			expect(
			...
			expect(cramMd5DigestBase64("hFPNx3x8q^09/y_a8gI73", "$Iw5FHR-dJa6^=#PwhqtF7$Uy=2fmsPemru0qj150", true)).toBe(
				"MDIxYzc4NjNmMDZhM2E1Zjk0ZDg5Njc3YWZjNDNkY2E="
			);
			expect(
				cramMd5DigestBase64(
			...
			expect(cramMd5DigestBase64("voxjx70j131lv9g645j6Znx8535l5Xb1nkl6CF0489lE2Gc^b*H&F5jn", "1$G15/iw", true)).toBe(
				"ODRmOWUzMjc0MDU1YTg3ZGI4NTQ1YzQ3MjEwMmQ1NmY="
			);
			expect(
				cramMd5DigestBase64(
	...
	describe("cramMd5Digest", () => {
		it("cramMd5Digest should be calculated right", () => {
			...
			).toBe("d6185588c4ea83078d6ab7c0bcede450");
			expect(
				cramMd5Digest(
					"(4_O)rt1BtMhs^boQIFVGN4^@U6m-5j@i",
					"(1C6hqgm2siyHl3*36#t17c/7h-7h!d!sLoyt8$vnoe3K5to7#^kcYx8$62b0w/Dt&lNs"
			...
			expect(cramMd5Digest("a5y6980m$8@Pds933I1e^C21@j0+7q6s56tl", "z25YGd5pejI384Tg8@950203XNm0Kk2(0/p4TKBh")).toBe(
